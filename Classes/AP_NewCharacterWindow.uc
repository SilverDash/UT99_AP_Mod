class AP_NewCharacterWindow extends NewCharacterWindow
	config(Archipelago);


var APItemManager LadderObj;
...
function Created()
{
	...
	class'APLadder'.Static.GetStubClass().Static.SetupWinParams(Self, Root, W, H);
	...
	if (class'APLadder'.Static.GetStubClass().Static.IsDemo())
		PreferredTeam = class'LadderAP'.Default.NumTeams + 2;

	MaleClass = class'LadderAP'.Default.LadderTeams[PreferredTeam].static.GetMaleClass();
	MaleSkin = class'LadderAP'.Default.LadderTeams[PreferredTeam].Default.MaleSkin;

	FemaleClass = class'LadderAP'.Default.LadderTeams[PreferredTeam].static.GetFemaleClass();
	FemaleSkin = class'LadderAP'.Default.LadderTeams[PreferredTeam].Default.FemaleSkin;
	...
	NameLabel.MyFont = class'APLadder'.Static.GetStubClass().Static.GetBigFont(Root);
	...
	NameButton.MyFont = class'APLadder'.Static.GetStubClass().Static.GetBigFont(Root);
	...
	SexLabel.MyFont = class'APLadder'.Static.GetStubClass().Static.GetBigFont(Root);
	...
	SexButton.MyFont = class'APLadder'.Static.GetStubClass().Static.GetBigFont(Root);
	...
	TeamLabel.MyFont = class'APLadder'.Static.GetStubClass().Static.GetBigFont(Root);
	...
	TeamButton.MyFont = class'APLadder'.Static.GetStubClass().Static.GetBigFont(Root);
	...
	NumTeams = class'Ladder'.default.NumTeams + int(class'LadderAP'.default.HasBeatenGame) * 2;
	if ((PreferredTeam == NumTeams) && (!class'APLadder'.Static.GetStubClass().Static.IsDemo()))
		PreferredTeam = 0;
	...
	FaceLabel.MyFont = class'APLadder'.Static.GetStubClass().Static.GetBigFont(Root);
	...
	FaceButton.MyFont = class'APLadder'.Static.GetStubClass().Static.GetBigFont(Root);
	...
	SkillLabel.MyFont = class'APLadder'.Static.GetStubClass().Static.GetBigFont(Root);
	...
	SkillButton.MyFont = class'APLadder'.Static.GetStubClass().Static.GetBigFont(Root);
	...
	TitleButton.MyFont = class'APLadder'.Static.GetStubClass().Static.GetHugeFont(Root);
	...
	BackButton.MyFont = class'APLadder'.Static.GetStubClass().Static.GetBigFont(Root);
	...
	NextButton.MyFont = class'APLadder'.Static.GetStubClass().Static.GetBigFont(Root);
	...
	TeamDescArea.MyFont = class'APLadder'.Static.GetStubClass().Static.GetSmallFont(Root);
	...
	DescScrollup.MyFont = class'APLadder'.Static.GetStubClass().Static.GetSmallFont(Root);
	...
	DescScrolldown.MyFont = class'APLadder'.Static.GetStubClass().Static.GetSmallFont(Root);
...
function Paint(Canvas C, float X, float Y)
{
	...
	if (Root.WinWidth > 500)
	{
		...
		DrawStretchedTexture(C, XOffset + (0 * W) + (65.0/1024*XMod), YOffset + (0 * H) + (61.0/768*YMod), (58.0/1024*XMod), (57.0/768*YMod), class'LadderAP'.Default.LadderTeams[PreferredTeam].Default.TeamSymbol);
	}
}
...
function NextPressed()
{
	...
	LadderObj.EXRank = 0;
	LadderObj.EXPosition = -1;
	LadderObj.EX2Rank = 0;
	LadderObj.EX2Position = -1;
	LadderObj.EX3Rank = 0;
	LadderObj.EX3Position = -1;

	LadderObj = None;
	Super.Close();
	ManagerWindow = APManagerWindow(Root.CreateWindow(class'APManagerWindow', 100, 100, 200, 200, Root, True));
}
