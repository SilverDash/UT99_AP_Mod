class APEnemyBrowser extends MeshBrowser;
...
function NextPressed()
{
    ...
    LOG("NEXT PRESSED FROM AP ENEMY BROWSER:"@Ladder.Default.MapPrefix$Ladder.Static.GetMap(Match));

	MapName = Ladder.Default.MapPrefix$Ladder.Static.GetMap(Match);
    LOG("NEXT PRESSED FROM AP ENEMY BROWSER: MAP NAME"@MapName); 
	CloseUp();
