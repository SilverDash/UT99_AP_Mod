class APManagerWindow extends ManagerWindow
	config(Archipelago);
...
// Team Deathmatch Ladder
var NotifyButton TDMLadderButton;
var localized string TDMText;
var DoorArea TDMDoor;
...
// Extra Ladder
var NotifyButton EXLadderButton;
var localized string EXText;
var DoorArea EXDoor;

// Extra Ladder
var NotifyButton EX2LadderButton;
var localized string EX2Text;
var DoorArea EX2Door;

// Extra Ladder
var NotifyButton EX3LadderButton;
var localized string EX3Text;
var DoorArea EX3Door;
...
var globalconfig int TDMDoorOpen[5], DMDoorOpen[5], CTFDoorOpen[5], ASDoorOpen[5], ChalDoorOpen[5], EXDoorOpen[5], EX2DoorOpen[5], EX3DoorOpen[5], TrophyDoorOpen[5];
...
defaultproperties
{
	...
	LadderTypes(0)="Archipelago.APDMLadder"
	LadderTypes(1)="Archipelago.APDomLadder"
	LadderTypes(2)="Archipelago.APCTFLadder"
	LadderTypes(3)="Archipelago.APASLadder"
	LadderTypes(4)="Archipelago.APChallengeLadder"
	DMText="Deathmatch"
	DOMText="Domination"
