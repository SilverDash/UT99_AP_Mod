//The Canvas side of the Ladder interface. 
//This is the Menu stuff NOT the gameplay stuff
class APLadder extends UTLadder
	abstract;
...
// Ladder
var Class<LadderAP> Ladder;
var Class<LadderAP> DemoLadder;
var Class<LadderAP> GOTYLadder;
...
function Created()
{
	...
	if (LadderObj == None)
	{
		Log("APLadder: Player has no LadderInventory!!");
	}
	...
	Title1.MyFont = class'APLadder'.Static.GetStubClass().Static.GetHugeFont(Root);
	...
	MaxBaseMatch = C - 8;
	Matches[C-1] = APMatchButton(CreateWindow(class'APMatchButton', XPos, YPos - i*YOffset, XWidth, YHeight));
	Matches[C-1].SetLadder(LadderObj.CurrentLadder);
	Matches[C-1].SetMatchIndex(C-1);
	Matches[C-1].MyFont = class'APLadder'.Static.GetStubClass().Static.GetBigFont(Root);
	...
	for (i=C-2; i>0; i--)
	{
		Matches[i] = APMatchButton(CreateWindow(class'APMatchButton', XPos, YPos - i*YOffset, XWidth, YHeight));
		Matches[i].SetLadder(LadderObj.CurrentLadder);
		Matches[i].SetMatchIndex(i);
		Matches[i].MyFont = class'APLadder'.Static.GetStubClass().Static.GetBigFont(Root);
	...
	Matches[0] = APMatchButton(CreateWindow(class'APMatchButton', XPos, YPos - i*YOffset, XWidth, YHeight));
	Matches[0].SetLadder(LadderObj.CurrentLadder);
	Matches[0].SetMatchIndex(0);
	Matches[0].MyFont = class'APLadder'.Static.GetStubClass().Static.GetBigFont(Root);
	...
	Scrollup.MyFont = class'APLadder'.Static.GetStubClass().Static.GetSmallFont(Root);
	...
	Scrolldown.MyFont = class'APLadder'.Static.GetStubClass().Static.GetSmallFont(Root);
	...
	MapInfoArea.MyFont = class'APLadder'.Static.GetStubClass().Static.GetSmallestFont(Root);
	...
	InfoScrollup.MyFont = class'APLadder'.Static.GetStubClass().Static.GetSmallFont(Root);
	...
	InfoScrolldown.MyFont = class'APLadder'.Static.GetStubClass().Static.GetSmallFont(Root);
...
function EvaluateMatch(optional bool bTrophyVictory)
{
	...
	if (LadderObj != None)
	{
		...
		class'AP_SlotWindow'.Default.Saves[LadderObj.Slot] = SaveString;
		class'AP_SlotWindow'.Static.StaticSaveConfig();
