class AP_SlotWindow extends SlotWindow
	config(Archipelago);
...
function RestoreGame(int i)
{
	...
	if (LadderObj == None)
	{
		...
		LadderObj = GetPlayerOwner().Spawn(class'APItemManager');
	...
	LadderObj.SkillText = class'AP_NewCharacterWindow'.Default.SkillText[LadderObj.TournamentDifficulty];
